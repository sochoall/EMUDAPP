        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int i) 
          {
            return CheckboxListTile(
              ...
              title: Text(estudiantes[i].nombre+" "+estudiantes[i].apellido),
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async 
        {
          try 
          {
            ...
            {
              json ='{"ces_id": "0", "ces_verificado": "${estudiante.verificado}", "mon_id": "${estudiante.monitoreo}", "est_id": "${estudiante.id}"}';
