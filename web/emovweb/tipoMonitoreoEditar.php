...
<div class="container text-center mt-2 ">
   <div class="row">
       <div class="col-md-6 offset-md-3">
           <div class="card">
                 <h3 class="card-header cyan white-text text-uppercase font-weight-bold text-center" id="titulo">TIPO DE MONITOREO</h3>
                 <div class="card-body">
...
?>
	...
	function IngMod(v) {	
		...
		if(valSololetras(nombre.value)==false){
			...
			var url=`${raizServidor}/tipoMonitoreo`;
			if(v.value=="Guardar"){	
			...
			if(v.value=="Modificar"){
				...
				var id =param.get('id');
				let redirigir="tipoMonitoreo.php";
