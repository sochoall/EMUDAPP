...
<div class="container">
    ...
    <div class="col">
		...
		<div class="form-group row">
			...
			<div class="col-sm-2 align-self-center">
				<SELECT id="campo"  class="browser-default custom-select"> 
					<OPTION VALUE="sen_nombre" selected >Nombre</OPTION>				
				</SELECT> 
			</div>
		...
		<div class="position-fixed btn-group-lg" style="bottom:20px; right:80px; width:120px; height:80px;">
			<a href="tipoSentidoEditar.php?metodo=Ingresar" class="cyan btn "  
	...
	<script type="text/javascript">		
		...
		function Buscar(){	
			...
			let url=`http://localhost:8888/sentido?campo=${campo}&bus=${textBuscar}&est=${estado}`;
			...
			.then(produ => {				
				...
				for(let prod of produ){						
					...
					`<tr> 
						...
						<td>
							<?php echo "<a href="?>tipoSentidoEditar.php?metodo=Modificar&id=${prod.id}
